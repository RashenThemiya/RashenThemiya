...
class AppNavigationScreen extends GetWidget<AppNavigationController> {
  ...
  /// Navigates to the loginOrRegisterScreen when the action is triggered.

  /// When the action is triggered, this function uses the [Get] package to
  /// push the named route for the loginOrRegisterScreen.
  onTapLoginorregister() {
    Get.toNamed(
